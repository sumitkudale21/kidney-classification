...
from cnnClassifier.pipline.stage_03_model_training import ModelTrainingPipeline
from cnnClassifier.pipline.stage_04_model_evaluation import EvaluationPipeline
